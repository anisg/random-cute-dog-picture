...
export function RenderBadgeLiveDesign(props: RenderBadgeLiveDesignProps) {
  ...
  <Span {...frames["madeOn"]} className={cls(frames, "madeOn")} style={{fontFamily: 'Inter', fontSize: 12, fontWeight: 500, color: '#26292f', textAlign: 'left', position: 'relative', ...frames["madeOn"]?.style}}>Made on</Span>
  ...
  <Span {...frames["liveDesign"]} className={cls(frames, "liveDesign")} style={{fontFamily: 'Inter', fontSize: 12, fontWeight: 500, color: '#26292f', textAlign: 'left', position: 'relative', ...frames["liveDesign"]?.style}}>LiveDesign</Span>
</Div>
    );
}