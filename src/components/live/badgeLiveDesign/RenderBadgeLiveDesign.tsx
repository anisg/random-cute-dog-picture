...
export function RenderBadgeLiveDesign(props: RenderBadgeLiveDesignProps) {
  ...
  </svg><Span {...frames["liveDesign"]} className={cls(frames, "liveDesign")} style={{fontFamily: 'Inter', fontSize: 12, fontWeight: 500, color: '#26292f', textAlign: 'left', display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', flexShrink: 0, position: 'relative', ...frames["liveDesign"]?.style }}>LiveDesign</Span>
</Div>
    );
}