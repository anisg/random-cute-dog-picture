...
export const RenderMainPage = function (props: RenderMainPageProps) {
    ...
    return (
        <Div {...frames["mainPage"]} className={cls(frames, "mainPage")} style={{gap: 30, flexDirection: 'column', justifyContent: 'center', alignItems: 'center', overflow: 'hidden', position: 'relative', padding: '85px 85px 85px 85px', backgroundColor: '#e9ecf1', opacity: 1, display: 'flex', ...frames["mainPage"]}}><Span {...frames["theServiceAllowsYouToGenerateACuteDogPictureAndDownloadIt"]} className={cls(frames, "theServiceAllowsYouToGenerateACuteDogPictureAndDownloadIt")} style={{fontFamily: 'Inter', fontSize: 14, fontWeight: 500, color: '#40454d', textAlign: 'left', display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', width: 283, flexShrink: 0, position: 'relative', ...frames["theServiceAllowsYouToGenerateACuteDogPictureAndDownloadIt"]}}>The service allows you to generate a cute dog picture and download it!</Span>
  <Div {...frames["frame1"]} className={cls(frames, "frame1")} style={{gap: 23, flexDirection: 'column', alignItems: 'center', flexShrink: 0, overflow: 'hidden', position: 'relative', border: '1px  SOLID #ebebeb', boxShadow: '0px 4px 4px rgba(0, 0, 0, 0.05000000074505806)', borderRadius: 12, padding: '25px 21px 17px 21px', backgroundColor: '#ffffff', opacity: 1, display: 'flex', ...frames["frame1"]}}>
    <Div {...frames["frame7"]} className={cls(frames, "frame7")} style={{gap: 8, flexDirection: 'column', flexShrink: 0, alignSelf: 'stretch', objectFit: 'cover', position: 'relative', padding: '0px 0px 0px 0px', opacity: 1, display: 'flex', ...frames["frame7"]}}>
      <Div {...frames["frame8"]} className={cls(frames, "frame8")} style={{gap: 10, flexDirection: 'row', width: 'fit-content', alignItems: 'flex-start', flexShrink: 0, position: 'relative', padding: '12px 12px 12px 12px', backgroundColor: '#ff0000', opacity: 1, display: 'flex', ...frames["frame8"]}}><Span {...frames["cuteDogPictureGenerator"]} className={cls(frames, "cuteDogPictureGenerator")} style={{fontFamily: 'Inter', fontSize: 18, fontWeight: 800, color: '#2f3136', textAlign: 'left', display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', width: 271, flexShrink: 0, position: 'relative', ...frames["cuteDogPictureGenerator"]}}>Cute Dog Picture Generator</Span>
      </Div>
    </Div>
