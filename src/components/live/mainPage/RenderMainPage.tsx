...
export const RenderMainPage = function (props: RenderMainPageProps) {
  ...
  <div className={cls(frames,"frame1", `gap-[23px] flex-col items-center shrink-0 overflow-hidden relative border shadow-[0px_4px_4px_rgba(0,0,0,0.05000000074505806)] bg-white opacity-100 pt-[25px] pb-[17px] px-[21px] rounded-xl border-[#ebebeb] flex`)}>
    <div className={cls(frames,"frame7", `gap-2 flex-col shrink-0 self-stretch object-cover relative opacity-100 p-0 flex`)}><span className={cls(frames,"cuteDogPictureGenerator", `font-['Inter'] text-lg font-extrabold text-[#2f3136] text-left flex flex-row justify-start w-[271px] shrink-0 relative`)}>Cute Dog Picture Generator</span>
    ...
    <div className={cls(frames,"frame6", `gap-[15px] flex-col items-stretch shrink-0 self-stretch object-cover relative opacity-100 p-0 flex`)}>
      <div className={cls(frames,"frame4Button", `gap-1.5 flex-col justify-center items-center shrink-0 self-stretch object-cover overflow-hidden relative bg-[#e9ecf1] opacity-100 px-[95px] py-5 rounded-md flex`)}><svg className="icon" width={65} height={64} viewBox="0 0 65 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        </svg><span className={cls(frames,"clickToGenerate", `font-['Inter'] text-xs font-medium text-[#949eae] text-left flex flex-row justify-start shrink-0 relative`)}>click to generate</span>
      </div>
      <div className={cls(frames,"frame5", `gap-[30px] flex-row justify-end items-center shrink-0 self-stretch object-cover relative opacity-100 p-0 flex`)}>
        <div className={cls(frames,"buttonDownloadButton", `gap-2.5 flex-row w-fit items-start shrink-0 overflow-hidden relative border bg-[#4281db] opacity-100 px-[11px] py-[5px] rounded-[3px] border-[#3d76c7] flex`)}><span className={cls(frames,"downloadImage", `font-['Inter'] text-sm font-semibold text-white text-left flex flex-row justify-start shrink-0 relative`)}>Download image</span>
        </div>
      </div>
    </div>
  </div>
