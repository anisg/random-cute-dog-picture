...
export function RenderTag(props: RenderTagProps) {
  ...
  <Span {...frames["photography"]} className={cls(frames, "photography")} style={{fontFamily: 'Helvetica Neue', fontSize: 12, fontWeight: 700, color: '#3f3f46', textAlign: 'center', display: 'flex', flexDirection: 'row', justifyContent: 'center', flexShrink: 0, position: 'relative', ...frames["photography"]?.style}}>#photography</Span>
</Div>
    );
}